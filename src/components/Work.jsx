...
const [images,setImages]=useState([
  ...
  const mainText="Insights and behind the scenes"
  const paraText="Explore what drives our team."
...
<Products/>
<Marquees/>
<Cards paraText={paraText}  mainText={mainText}  nextText="Up Next:News" secondText={secondText} headText="Get in Touch" />
<Footer/>
    </>
  )
}
